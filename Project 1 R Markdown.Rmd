...
We'll start with a scatter plot comparing the sums of all the advantages we calculated against all other types vs the number of that type of Pokemon that exist to get a general sense of what we're looking at here.  
